                            ...
                            <div className="card" style={{ width: "18rem" }} key={index}>
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <div className="d-flex justify-content-center gap-3">
                                        <a href={member["github"]} className="text-body-secondary"><i class="bi bi-github fs-4"></i></a>
                                        <a href={member["linkedin"]} className="text-body-secondary"><i class="bi bi-linkedin fs-4"></i></a>
                                        <a href={member["instagram"]} className="text-body-secondary"><i class="bi bi-instagram fs-4"></i></a>
                                    </div>
                                </div>
                            </div>
                        )
